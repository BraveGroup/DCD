...
_C.INPUT.MULTI_TRAIN_SIZE=((1120,640), (1376,768), (1600,896), (1824,1024), (2048,1152))
...
_C.DATASETS.USE_TTA = False
_C.DATASETS.TTA_AUG_PARAMS = [[0.0]]
_C.DATASETS.MAX_CLASSES_NUM = 3
_C.DATASETS.INFER_ON_RIGHT_IMG = False
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.MODEL.BACKBONE.TYPE = 'DGDE'
_C.MODEL.BACKBONE.USE_FPN = False
_C.MODEL.BACKBONE.FPN_STRIDE = [8,16,32,64,128]
# ---------------------------------------------------------------------------- #
# Group Norm options
# ---------------------------------------------------------------------------- #
...
#extra kpts num
_C.MODEL.HEAD.EXTRA_KPTS_NUM = 63
_C.MODEL.HEAD.USE_2D_3D_KPTS_LOC_LOSS = False
_C.MODEL.HEAD.KPTS_3D_EGO = False

#deeper head
_C.MODEL.HEAD.DEEPER_HEAD = False
_C.MODEL.HEAD.STACKED_CONVS = 2
_C.MODEL.HEAD.DCN_ON_LAST_CONV = True
...
_C.MODEL.HEAD.ACTIVE_FUNC = "relu"
...
_C.MODEL.HEAD.DEPTH_MODE = 'inv_sigmoid' # or linear
...
_C.MODEL.HEAD.SCALE_DEPTH_BY_FOCAL_LENGTHS_FACTOR = 800
...
_C.MODEL.FREEZE_BACKBONE_EPOCH = -1
_C.MODEL.FREEZE_BACKBONE_STEPS = -1
_C.MODEL.FREEZE_NAME =[]

_C.MODEL.BATCH_WEIGHT_FACTOR = 18 #average obj num 
###nusc only
_C.MODEL.ATTR_AND_VELO = False
# ---------------------------------------------------------------------------- #
# Solver
# ---------------------------------------------------------------------------- #
_C.SOLVER = CN()
...
_C.SOLVER.EVAL_AND_SAVE_EPOCH = True
...
_C.TEST.GENERATE_GMW = False
_C.TEST.GEN_DATA_AT_FINISH = False
...
_C.TEST.VISUALIZE_THRESHOLD = 1e-2
_C.TEST.USE_ONLY_EXTRA_KPTS= False
